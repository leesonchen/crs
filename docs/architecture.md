...
│         ▼                                                       │
│  ┌─────────────────────────────────────┐                       │
│  │      Relay Service (Refactored)     │                       │
│  ├─────────────────────────────────────┤                       │
│  │ 1. 构建 HTTP 请求                   │                       │
│  │    - Headers (含 Codex API 特殊头) │                       │
│  │    - Proxy 配置                     │                       │
│  │ 2. 发送到上游 API                   │                       │
│  │ 3. 处理响应（流式/非流式）          │                       │
│  └─────────────────────────────────────┘                       │
...
│         ▼                                                       │
│  ┌─────────────┐                                               │
│  │ Upstream    │ OpenAI / Codex API                            │
│  │   API       │                                               │
│  └─────────────┘                                               │
│         │                                                       │
│         ▼                                                       │
│  ┌─────────────┐                                               │
│  │ Response    │ 转换回 Claude 格式（使用转换器）               │
│  │ Transform   │                                               │
│  └─────────────┘                                               │
│         │                                                       │
│         ▼                                                       │

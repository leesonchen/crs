...
const PLATFORM_CONFIG = {
  ...
  'gemini-api': { endpoint: 'gemini-api-accounts', stateKey: 'geminiApiAccounts' },
...
export const useAccountsStore = defineStore('accounts', () => {
  ...
  const fetchGeminiApiAccounts = () =>
    fetchAccounts(httpApis.getGeminiApiAccountsApi, geminiApiAccounts)
  ...
  const updateGeminiApiAccount = (id, data) =>
    mutateAccount(httpApis.updateGeminiApiAccountApi, fetchGeminiApiAccounts, id, data)
  ...
  const toggleAccount = async (platform, id) => {
    ...
    if (res.success) {
      const fetchMap = {
        ...
        'gemini-api': fetchGeminiApiAccounts,
